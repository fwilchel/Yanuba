 ...
 && eliminación de repetidos, Horas por empleado
 SELECT DISTINCT * FROM paso1previo INTO CURSOR paso1
 COPY TO paso1.xls TYPE XLS
 
 && Para Incentivo Mostrador, calculo de horas y conteo (Número de personas por rol)
 ...
 && Validación porcentajes almacen
 ...
 BROWSE NOAPPEND NODELETE NORMAL TITLE 'Validación porcentajes almacen'
